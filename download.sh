...
WEAPON_ASSET_BUCKET_ID="${HF_WEAPON_ASSET_BUCKET_ID:-${HF_ASSET_BUCKET_ID:-mobilint/aries-weapon-detection-demo-assets}}"
FALL_ASSET_BUCKET_ID="${HF_FALL_ASSET_BUCKET_ID:-mobilint/aries-fall-detection-demo-assets}"
WEAPON_ASSET_BUCKET_URI="hf://buckets/${WEAPON_ASSET_BUCKET_ID}"
FALL_ASSET_BUCKET_URI="hf://buckets/${FALL_ASSET_BUCKET_ID}"
