...
export default function VisionStream({
  ...
  highlightedChannelIndices?: number[] | null;
  ...
  const canvasAspectRatio = layoutMetadata != null
      ...
      {displayRect != null && layoutMetadata != null &&
        ...
        >
          {layoutMetadata.channels.map((channel) => {
            ...
            const activeChannelIndices = highlightedChannelIndices === undefined
              ? selectedChannelIndex == null ? [] : [selectedChannelIndex]
              : highlightedChannelIndices ?? [];
            const isHighlighted = activeChannelIndices.includes(channel.channel_index);
              ...
              <Box
                ...
                sx={{
                  ...
                  boxShadow: isHighlighted
                    ...
                    : "none",
                  "&:hover": {
                    border: disabled ? undefined : "4px solid rgba(30, 136, 255, 0.9)",
                    backgroundColor: disabled ? undefined : "rgba(30, 136, 255, 0.06)",
                    boxShadow: disabled ? undefined : "inset 0 0 0 2px rgba(30, 136, 255, 0.28), 0 0 0 2px rgba(30, 136, 255, 0.18)",
                  },
                  "&:focus-visible": {
                    outline: "none",
