...
export default function Page() {
  ...
  const [isGoodwayLogo, setIsGoodwayLogo] = useState(false);
        ...
        >
          ...
          >
            <Grid2 container alignItems="center" wrap="nowrap" columnSpacing="26px" sx={{ minWidth: 0 }}>
              ...
              <Box
                component="img"
                src={isGoodwayLogo ? "/goodway_logo.png" : "/DFI_logo.png"}
                alt={isGoodwayLogo ? "Goodway" : "DFI"}
                onContextMenu={(event) => {
                  event.preventDefault();
                  setIsGoodwayLogo((prev) => !prev);
                }}
